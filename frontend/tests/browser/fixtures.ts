  ...
  await page.route("**/api/**", async (route) => {
    ...
    const table: Record<string, unknown> = {
      ...
      "/v1/llm/status": {
        ...
        latency_ms: 3,
        configured_fallbacks: ["heuristic"],
      ...
      "/v1/evidence/retrieve": {
        status: "OK",
        retrieval_stage: "RELAXED_SERVICE",
        retrieval_time_ms: 12.5,
        candidate_count: 7,
        stages_attempted: ["STRICT_CONTEXT", "RELAXED_SERVICE"],
        relaxed_filters: ["service"],
        semantic_available: true,
        warnings: [],
        filters_applied: { schema_version: 2 },
        results: [
          {
            id: "RB-001",
            ...
            final_score: 0.92,
            tags: ["postgres"],
            text: "Review connection limits.",
            why_retrieved: [
              "same technology: postgresql",
              "matching HTTP 503 signal",
            ],
      ...
      "/evaluation/benchmark": {
        ...
        safety: {
          status: "not_measured",
          reason:
            "This endpoint evaluates retrieval only; safety invariants are tested separately.",
        },
        baselines: [
          {
        ...
        limitations: ["Small curated test corpus; not a scale benchmark"],
      },
      "/tools/action": {
        status: "blocked",
        decision: "BLOCK",
